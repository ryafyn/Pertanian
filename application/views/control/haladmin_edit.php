...
<div class="container">
    <h2 class="mb-4 text-center" style="color: #00e600;">Edit Data Admin</h2>
    ...
    <form action="<?php echo site_url('c_haladmin/update/' . $admin['username']); ?>" method="post" enctype="multipart/form-data">
        <div class="mb-3">
