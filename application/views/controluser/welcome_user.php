...
<div style="height: 100vh; display: flex;">
    <div class="left-side" style="width: 50%; padding: 30px; text-align: center; background-color: #00e600; color: black;">
        ...
        <div style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 20px;">
            <a href="halproduk.php" style="color: white; flex: 1 1 48%; text-align: center; padding: 2px; background-color: #00e600; border-radius: 5px; transition: background-color 0.3s, transform 0.3s; text-decoration: none;">
                <i class="fa fa-cart-arrow-down"></i> Halaman Produk
            </a>
            <a href="haluser.php" style="color: white; flex: 1 1 48%; text-align: center; padding: 2px; background-color: #00e600; border-radius: 5px; transition: background-color 0.3s, transform 0.3s; text-decoration: none;">
    ...
    <div class="right-side" style="width: 50%; padding: 30px; text-align: center; background-color: white;">
        <?php if(isset($_SESSION['username'])) { ?>
            ...
            <button type="submit" 
                style="width: 50%; background-color: #008000;  border: none; padding: 10px; border-radius: 5px; cursor: pointer; transition: background-color 0.3s ease;">
